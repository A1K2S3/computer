...
$('document').ready(function(){
     ...
     $('.main .sub .ischeme .semI .english').click(function(){
     ...
     $('.main .sub .ischeme .semI .basicscience').click(function(){
     ...
     $('.main .sub .ischeme .semI .basicmathematics').click(function(){
     ...
     $('.main .sub .ischeme .semII .basicelectronics').click(function(){
     ...
     $('.main .sub .ischeme .semII .programminginc').click(function(){
     ...
     $('.main .sub .ischeme .semII .appliedmathematics').click(function(){
     ...
     $('.main .sub .ischeme .semII .elementsofelectricalengineering').click(function(){
     ...
     $('.main .sub .ischeme .semIII .datastructure').click(function(){
     ...
     $('.main .sub .ischeme .semIII .digitaltechniques').click(function(){
     ...
     $('.main .sub .ischeme .semIII .computergraphics').click(function(){
     ...
     $('.main .sub .ischeme .semIII .objectorientedprogramming').click(function(){
     ...
     $('.main .sub .ischeme .semIII .database').click(function(){
